...
function buildSvgSymbol(bearing: number): google.maps.Symbol {
    return {
        ...
        anchor: new google.maps.Point(6000, 3000) // Approx center for this specific path
    };
}
